            ...
            <div class="collapse navbar-collapse main-menu-wrap" id="navbarSupportedContent">
              ...
              <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item d-lg-none">
                  <a href="https://www.cry.org/donate-to-educate-girls/?utm_source=google&utm_medium=cpc&utm_campaign=61420&utm_term=donate%20for%20girls&utm_content=search+text+ads+girl+child+broad+gen+t1&campaign_Name=GirlChild&gad_source=1"
                    target="_blank" class="nav-link btn style1">Donate Now</a>
                </li>
              </ul>
              <div class="other-options md-none">
                ...
                <div class="option-item">
                  <a href="https://www.cry.org/donate-to-educate-girls/?utm_source=google&utm_medium=cpc&utm_campaign=61420&utm_term=donate%20for%20girls&utm_content=search+text+ads+girl+child+broad+gen+t1&campaign_Name=GirlChild&gad_source=1"
                    target="_blank" class="btn style1">Donate Now</a>
                </div>
              </div>
            </div>
          </nav>
        ...
        <div class="row pt-100 pb-75">
          <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 pe-xl-5">
            <div class="footer-widget">
              ...
              <p class="comp-desc">
                Let's unite in action to dismantle barriers and ensure equality flourishes in every corner of society,
